...
export default function Cookies() {
  ...
  const sections = legalSectionsI18n[lang].cookies;
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container max-w-4xl py-16">
        <div className="max-w-3xl">
          <h1 className="text-5xl md:text-6xl font-semibold tracking-tight">{t.cookiesTitle}</h1>
          <p className="mt-2 text-slate-500">{t.cookiesUpdated}</p>
        </div>

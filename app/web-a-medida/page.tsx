...
const t = {
  es: {
    ...
    studioVsCustom: 'La Web a Medida (2.900€) es para marcas que necesitan diseño exclusivo, copy profesional, estructura a medida y entrega llave en mano sin tocar el Studio.',
    ...
    steps: [
      ...
      { title: '2. Propuesta y presupuesto cerrado (Día 1–2)', desc: 'Recibes un documento con alcance, calendario y precio final: 2.900€ + IVA. Sin cuotas mensuales ni costes ocultos. Si encaja, firmamos y arrancamos.' },
    ...
    includesTitle: 'Qué incluye los 2.900€',
    includes: [
    ...
    price: '2.900€',
    priceNote: '+ IVA · Pago único · Sin permanencia · Sin cuotas ocultas',
    priceBreakdown: 'Equivale a un proyecto de agencia tradicional (5.000–12.000€) con la agilidad de CREAUNA.',
  ...
  en: {
    ...
    studioVsCustom: 'Custom Web (€2,900) is for brands that need exclusive design, professional copy, custom structure and turnkey delivery without using Studio.',
    ...
    steps: [
      ...
      { title: '2. Proposal and fixed quote (Day 1–2)', desc: 'You receive scope, timeline and final price: €2,900 + VAT. No monthly fees or hidden costs. If it fits, we sign and start.' },
    ...
    includesTitle: 'What €2,900 includes',
    includes: [
    ...
    price: '€2,900',
    priceNote: '+ VAT · One-time payment · No lock-in · No hidden fees',
    priceBreakdown: 'Equivalent to a traditional agency project (€5,000–12,000) with CREAUNA agility.',

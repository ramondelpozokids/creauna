...
export const SECTOR_CATALOG: SectorEntry[] = [
  ...
  { id: 'arquitectura', labelEs: 'Arquitectura', labelEn: 'Architecture', groupEs: 'Hogar y Construcción', groupEn: 'Home & Construction', templateSlug: 'blueprint', tier: 'priority', keywords: /estudio de arquitectura|arquitectura contempor|\barquitectura\b|interiorismo profesional|obra nueva|proyecto arquitect/i, promptHintEs: 'Estudio de arquitectura con portfolio, servicios y contacto' },
  { id: 'moda-ecommerce', labelEs: 'Moda & eCommerce', labelEn: 'Fashion eCommerce', groupEs: 'Ecommerce', groupEn: 'E-commerce', templateSlug: 'maison', tier: 'priority', keywords: /ecommerce|e-commerce|tienda online|tienda de moda|carrito|checkout|stripe|woocommerce|shopify|lookbook|moda premium|luxury fashion|zara|massimo dutti|gymshark|gucci|dior/i, promptHintEs: 'Tienda de moda premium con catálogo, carrito y checkout' },
  ...
  { id: 'joyeria', labelEs: 'Joyería y relojería', labelEn: 'Jewelry & Watches', groupEs: 'Lujo', groupEn: 'Luxury', templateSlug: 'atelier', tier: 'priority', keywords: /joyer[ií]a|relojer[ií]a|jewelry|watch|rolex|cartier|patek|omega|alta relojer/i, promptHintEs: 'Joyería y relojería de lujo con marcas, galería, cita privada y taller' },

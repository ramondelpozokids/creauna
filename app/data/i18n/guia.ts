  ...
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Si prefieres empezar con una base visual, tenemos 60 plantillas premium (12 por categoría) en 5 sectores:',
        ...
        categories: [
          'Gastronomía (12 plantillas)',
          'Servicios (12 plantillas)',
          'Lujo & Estilo (12 plantillas)',
          'Corporativo (12 plantillas)',
          'Tecnología (12 plantillas)',
        ],
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'If you prefer a visual starting point, we offer 60 premium templates (12 per category) in 5 sectors:',
          'Each template has an image matching its sector. Pick one, open it in Studio and customize text, colors and photos.',
        ],
        categories: [
          'Gastronomy (12 templates)',
          'Services (12 templates)',
          'Luxury & Style (12 templates)',

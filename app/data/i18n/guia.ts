  ...
  es: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Si prefieres empezar con una base visual, tenemos 9 muestras profesionales terminadas por sector — webs reales listas para personalizar:',
          'Elige una muestra, mira la demo en vivo y personalízala en el Studio con tu nombre, teléfono y fotos.',
        ],
        categories: [
          'Mesón La Colonia — Restauración',
          'Lumina Dental · Vitalis · Armonía Vital — Salud',
          'Aura Estates — Inmobiliaria',
          'Aura Sanctuary — Hotel',
          'Apex Athletics — Gimnasio',
          'Aeterna & Co. — Joyería',
          'Aura Architects — Arquitectura',
        ],
        link: { href: '/templates', label: 'Ver muestras profesionales' },
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'If you prefer a visual starting point, we offer 9 finished professional samples by industry — real sites ready to customize:',
          'Pick a sample, view the live demo and customize it in Studio with your name, phone and photos.',
        ],
        categories: [
          'Mesón La Colonia — Restaurant',
          'Lumina Dental · Vitalis · Armonía Vital — Health',
          'Aura Estates — Real estate',
          'Aura Sanctuary — Hotel',
          'Apex Athletics — Gym',
          'Aeterna & Co. — Jewelry',
          'Aura Architects — Architecture',
        ],
        link: { href: '/templates', label: 'View professional samples' },
      },
      {
        id: 'creditos', icon: Coins, color: 'text-amber-600 bg-amber-50',

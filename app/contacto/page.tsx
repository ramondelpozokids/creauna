...
function ContactForm() {
  ...
  useEffect(() => {
    ...
    setForm((prev) => ({
      ...prev,
      type: tipo && VALID_TYPES.has(tipo) ? tipo : prev.type,
      message:
        mensaje?.trim() ||
        (tema
          ? lang === 'es'
            ? `Hola, necesito un presupuesto para: ${tema}.\n\nDetalle:\n`
            : `Hi, I’d like a quote for: ${tema}.\n\nDetails:\n`
          : prev.message),
    }));
  }, [searchParams, lang]);
          ...
          <div className="space-y-4 text-sm">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a
                  href="mailto:info@ramondelpozorott.es"
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 text-slate-900 font-sans antialiased">
      ...
      <div className="container pt-20 pb-20 max-w-6xl">
        <Suspense fallback={<div className="mt-6 h-96 animate-pulse rounded-[2.5rem] bg-white border border-slate-200" />}>
          <ContactForm />
        </Suspense>
      </div>
    </div>

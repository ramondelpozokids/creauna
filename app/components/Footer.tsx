        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-y-10">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-slate-400">
              ...
              <Link href="/guia" className="footer-link block hover:text-white">Guía completa</Link>
              <Link href="/como-funciona" className="footer-link block hover:text-white">Cómo funciona</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-slate-400">
              ...
              <Link href="/contacto" className="footer-link block hover:text-white">Contacto</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-slate-400">
              ...
              <a href="https://wa.me/34656398640" target="_blank" rel="noopener noreferrer" className="footer-link block hover:text-white">WhatsApp (solo urgencias)</a>

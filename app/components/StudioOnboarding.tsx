...
const copy = {
  es: {
    ...
    catalogDesc: '18 webs profesionales terminadas — solo para ver cómo trabajamos. Sin personalización.',
  ...
  en: {
    ...
    catalogDesc: '18 finished professional sites — browse our work. View only, no customization.',

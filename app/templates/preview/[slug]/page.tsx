    ...
    return (
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="container pt-32 text-center">
          <h1 className="text-2xl font-bold">{lang === 'es' ? 'Plantilla no encontrada' : 'Template not found'}</h1>
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex-1 pt-16 flex flex-col min-h-0">
        ...
        <div className="flex-1 min-h-0">
          <TemplatePreviewFrame template={template} lang={lang} fullscreen={false} showActions />
        </div>
      </div>
    </div>
  );

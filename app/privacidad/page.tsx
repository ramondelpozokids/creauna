...
export default function Privacidad() {
  ...
  const sections = legalSectionsI18n[lang].privacy;
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container max-w-4xl py-16">
        <div className="max-w-3xl">
          <h1 className="text-5xl md:text-6xl font-semibold tracking-tight">{t.privacyTitle}</h1>
          <p className="mt-2 text-slate-500">{t.privacyUpdated}</p>
        </div>

...
const translations = {
  es: {
    badge: 'PRECIOS COMO WIX, SQUARESPACE O WEBFLOW',
    title: 'Elige tu plan. Publica tu web.',
    subtitle:
      'Misma lógica que las plataformas líderes: plan Free para probar, plan Core para tu negocio y plan Business para equipos. Con Studio IA incluido en todos.',
    monthly: 'Mensual',
    yearly: 'Anual',
    yearlySave: '−20%',
    ...
    compareMarketTitle: 'Precios de entrada vs. el mercado (2026)',
    compareMarketSubtitle:
      'Referencia orientativa de lo que cobran Wix, Squarespace, Webflow y Framer en facturación anual. CREAUNA incluye edición con IA en el precio.',
    compareColPlatform: 'Plataforma',
    compareColEntry: 'Plan de entrada',
    compareColPrice: 'Desde',
    compareColAi: 'IA integrada',
    marketRows: [
      { platform: 'Wix', plan: 'Light', price: '~17€/mes', ai: 'Wix AI (limitado)' },
      { platform: 'Squarespace', plan: 'Personal', price: '~16€/mes', ai: 'Blueprint AI' },
      { platform: 'Webflow', plan: 'Basic', price: '~14€/mes', ai: '—' },
      { platform: 'Framer', plan: 'Basic', price: '~15€/mes', ai: 'Framer AI' },
      { platform: 'CREAUNA', plan: 'Pro', price: '15€/mes', ai: '120 créditos Studio/mes', highlight: true },
    ],
    ...
    creditsTitle: 'Créditos Studio: el extra que no tienen Wix ni Squarespace',
    creditsSubtitle:
      'En otras plataformas pagas el plan y editas a mano. En CREAUNA cada plan incluye créditos para pedir cambios por chat: textos, colores, secciones y estilos con IA.',
  ...
  en: {
    badge: 'PRICING LIKE WIX, SQUARESPACE OR WEBFLOW',
    title: 'Pick your plan. Launch your site.',
    subtitle:
      'Same logic as leading builders: Free to try, Core for your business, Business for teams. AI Studio included on every plan.',
    monthly: 'Monthly',
    yearly: 'Yearly',
    yearlySave: '−20%',
    ...
    compareMarketTitle: 'Entry pricing vs. the market (2026)',
    compareMarketSubtitle:
      'Indicative reference for Wix, Squarespace, Webflow and Framer on annual billing. CREAUNA includes AI editing in the price.',
    compareColPlatform: 'Platform',
    compareColEntry: 'Entry plan',
    compareColPrice: 'From',
    compareColAi: 'Built-in AI',
    marketRows: [
      { platform: 'Wix', plan: 'Light', price: '~€17/mo', ai: 'Wix AI (limited)' },
      { platform: 'Squarespace', plan: 'Personal', price: '~€16/mo', ai: 'Blueprint AI' },
      { platform: 'Webflow', plan: 'Basic', price: '~€14/mo', ai: '—' },
      { platform: 'Framer', plan: 'Basic', price: '~€15/mo', ai: 'Framer AI' },
      { platform: 'CREAUNA', plan: 'Pro', price: '€15/mo', ai: '120 Studio credits/mo', highlight: true },
    ],
    ...
    creditsTitle: 'Studio credits: what Wix and Squarespace do not bundle',
    creditsSubtitle:
      'Other builders charge for the plan and you edit manually. CREAUNA includes credits to request chat-driven changes: copy, colors, sections and styles with AI.',
...
const plans = [
  {
    ...
    name: 'Gratis',
    nameEn: 'Free',
    taglineEs: 'Como el plan Free de Wix o Webflow',
    taglineEn: 'Like Wix or Webflow Free',
    priceMonthly: 0,
    priceYearly: 0,
    yearlyTotal: 0,
    credits: 15,
  ...
  },
  {
    ...
    name: 'Pro',
    nameEn: 'Pro',
    taglineEs: 'Como Squarespace Personal o Wix Core',
    taglineEn: 'Like Squarespace Personal or Wix Core',
    priceMonthly: 19,
    priceYearly: 15,
    yearlyTotal: 180,
    credits: 120,
  ...
  },
  {
    ...
    name: 'Business',
    nameEn: 'Business',
    taglineEs: 'Como Wix Business o Webflow CMS',
    taglineEn: 'Like Wix Business or Webflow CMS',
    priceMonthly: 49,
    priceYearly: 39,
    yearlyTotal: 468,
    credits: 300,
...
const faqs = [
  {
    q: '¿En qué se diferencia CREAUNA de Wix o Squarespace?',
    qEn: 'How is CREAUNA different from Wix or Squarespace?',
    a: 'Misma idea de planes por niveles (Free → Pro → Business), pero CREAUNA incluye un Studio con IA: describes cambios en lenguaje natural y ves el resultado al instante. Cada cambio consume 1 crédito incluido en tu plan. No arrastras bloques durante horas.',
    aEn: 'Same tiered plan idea (Free → Pro → Business), but CREAUNA includes an AI Studio: describe changes in plain language and see results instantly. Each change uses 1 credit included in your plan. No hours of drag-and-drop.',
  },
  {
    q: '¿Puedo empezar gratis como en Wix?',
    qEn: 'Can I start free like on Wix?',
  ...
  },
  {
    ...
    a: 'Pro incluye 14 días de prueba sin compromiso, como Squarespace. Puedes cancelar antes de que se cobre el primer mes.',
    aEn: 'Pro includes a 14-day no-commitment trial, like Squarespace. Cancel before the first charge if it is not for you.',
  },
  {
    q: '¿Puedo exportar y llevarme la web?',
    qEn: 'Can I export and take my site elsewhere?',
    a: 'Sí, en Pro y Business exportas HTML/CSS/JS limpio y lo alojas donde quieras, como en Webflow. Sin penalización.',
    aEn: 'Yes, on Pro and Business you export clean HTML/CSS/JS and host it anywhere, like Webflow. No penalty.',
  },
  {

(function () {
  ...
  const T = {
    es: {
      ...
      waves_on: 'Activar olas',
      waves_off: 'Silenciar olas',
      waves_title: 'Sonido del mar',
    ...
    en: {
      ...
      waves_on: 'Turn on waves',
      waves_off: 'Mute waves',
      waves_title: 'Sea sound',
    ...
    fr: {
      ...
      waves_on: 'Activer les vagues',
      waves_off: 'Couper les vagues',
      waves_title: 'Son de la mer',
    ...
    de: {
      ...
      waves_on: 'Wellen einschalten',
      waves_off: 'Wellen stummschalten',
      waves_title: 'Meeresrauschen',
    ...
    it: {
      ...
      waves_on: 'Attiva le onde',
      waves_off: 'Silenzia le onde',
      waves_title: 'Suono del mare',

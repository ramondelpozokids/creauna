(function () {
  ...
  const T = {
    es: {
      ...
      ambient_on: 'Activar sonido del mar',
      ambient_off: 'Silenciar el mar',
      ambient_title: 'Olas del Mediterráneo',
    ...
    en: {
      ...
      ambient_on: 'Turn on sea sound',
      ambient_off: 'Mute the sea',
      ambient_title: 'Mediterranean waves',
    ...
    fr: {
      ...
      ambient_on: 'Activer le son de la mer',
      ambient_off: 'Couper le son de la mer',
      ambient_title: 'Vagues de la Méditerranée',
    ...
    de: {
      ...
      ambient_on: 'Meeresrauschen einschalten',
      ambient_off: 'Meer stummschalten',
      ambient_title: 'Mittelmeerwellen',
    ...
    it: {
      ...
      ambient_on: 'Attiva il suono del mare',
      ambient_off: 'Silenzia il mare',
      ambient_title: 'Onde del Mediterraneo',
      hero_scroll: 'Scopri',
      about_eyebrow: 'Antonio Perujo · La Carihuela',
